...
<button {{ $attributes->merge(['type' => 'submit', 'class' => ' btn btn-success w-full h-32 text-3xl  inline-flex items-center justify-center   font-semibold  uppercase  rounded-none']) }}>
    {{ $slot }}
</button>