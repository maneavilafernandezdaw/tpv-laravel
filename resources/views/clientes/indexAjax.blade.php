        ...
        "paginate": {
            ...
            "previous": "Anterior"
                ...
                columns: [
                    ...
                    {data: 'cif', name: 'cif', "className":" fw-bold align-middle "},
                    {data: 'direccion', name: 'direccion', "className":"fw-bold   align-middle"},
                    {data: 'email', name: 'email', "className":" fw-bold  align-middle"},
                    {data: 'action', name: 'action', orderable: true, "className":"  align-middle"},
