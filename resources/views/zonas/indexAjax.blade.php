            ...
            <div class="modal-content">
                 <form method="post" id="sample_form" class="form-horizontal">
                     ...
                     <div class="modal-body">
                         <span id="gif" class="flex flex-col justify-center items-center"><img src="imagen/cargando.gif" class=" w-20" alt="Cargando..." />
                            <span id="form_result" class="text-xl fw-semibold text-center text-dark "></span></span>
                         
                         <div class="form-group">
                             <label>Nombre : </label>
                             <input type="text" name="nombre" id="nombre" class="form-control rounded-md" required />
                         </div>
                     
                         <div class="form-group">
                             <label>Mesas: </label>
                             <input type="number" name="mesas" min="1"  id="mesas"   class="form-control rounded-md" required />
                         </div>
    ...
    <div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
        ...
        <form method="post" id="sample_form" class="form-horizontal">
            ...
            <div class="modal-footer">
                ...
                <button type="button" name="ok_button" id="ok_button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-4xl px-2.5 py-2.5 text-center me-2 mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
        ...
        "paginate": {
            ...
            "previous": "Anterior"
                ...
                columns: [
                    ...
                    {data: 'nombre', name: 'nombre', "className":"fw-bold  align-middle"},
                    {data: 'mesas', name: 'mesas', "className":"fw-bold  align-middle"},
                    {data: 'action', name: 'action', orderable: true, "className":"fw-bold  align-middle"},
            ...
            beforeSend:function(){
                ...
                $('.modal-footer').addClass('hidden');
                    ...
                    success:function(data)
                    {
                        html = '<div class="alert alert-success text-lg fw-semibold bg-warning">' + data.success + '</div>';
                        $('#aviso').html(html);
                        setTimeout(function(){
