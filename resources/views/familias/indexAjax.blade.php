<x-app-layout>
    ...
    <div class="container mt-3 card rounded-none">
        ...
        <div class="card-body  rounded-none my-3">
            <table id="familias_Datatables" class="table  table-striped table-hover ">
                <thead>
                    <tr>
                    ...
                    <form method="post" id="sample_form" class="form-horizontal">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="combinada" id="combinada"
                                    value="1">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#familias_Datatables').DataTable({
            ...
            $('#sample_form').on('submit', function(event) {
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('familiasAjax.store') }}";
                }

                if ($('#action').val() == 'Edit') {
                    action_url = "{{ route('familiasAjax.update') }}";
                }
                    ...
                    success: function(data) {
                        ...
                        if (data.success) {
                            ...
                            setTimeout(function() {
                                ...
                                $('#familias_Datatables').DataTable().ajax.reload();
                            }, 1000);
                        }
            ...
            $(document).on('click', '.delete', function() {
                ...
                $('#aviso').html('¿Estás seguro de eliminar la Familia?');
                $('.modal-footer').removeClass('hidden');
            });
